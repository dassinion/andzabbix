...
import ru.sonic.zabbix.pro.adapters.ActionsAdapter;

import ru.sonic.zabbix.pro.api.ActionApiHandler;
...
public class ActionsListActivity extends DefaultZabbixListActivity {
	private ActionApiHandler api = null;
	
	@Override
	public void onCreate(Bundle savedInstanceState) {
		super.onCreate(savedInstanceState);
		api = new ActionApiHandler(this,getSelectedServer());
		...
		lv.setOnCreateContextMenuListener(new OnCreateContextMenuListener() {  
            public void onCreateContextMenu(ContextMenu menu, View v, ContextMenuInfo info) {   
                ...
                Action obj=(Action)(lv.getAdapter().getItem(minfo.position));
                if (obj.getEnStatus())
	...
	public void setListContent(List data) {
		...
		ActionsAdapter hostAdapter = new ActionsAdapter(this,data); 
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		final View layout = inflater.inflate(R.layout.action_create, null);
	...
	public JSONArray exec(String operation, Object obj) throws ZabbixAPIException {
		if (operation.equals("create"))
			return api.create((Action) obj);
		else if (operation.equals("enable")) {
			((Action) obj).setStatus("0");
			return api.edit((Action) obj);
		} else if (operation.equals("disable")) {
			((Action) obj).setStatus("1");
			return api.edit((Action) obj);
		} else if (operation.equals("delete")) {
			api.delete(((Action) obj));
			return null;
		} else {
			return null;
		}
