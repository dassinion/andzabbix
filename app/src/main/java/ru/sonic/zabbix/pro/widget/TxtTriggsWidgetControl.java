...
public class TxtTriggsWidgetControl extends Activity {
    ...
    private static final String TAG = "TxtTriggsWidgetControl";
    private int appWidgetId = AppWidgetManager.INVALID_APPWIDGET_ID;
    private static final String WIDGETBOUGHT = "TEXTWidgetBought";
    IabHelper mHelper;
    boolean widgetbought = false;
    static final String WIDGET_TEXT_ITEM = "widget_text_item";
    ...
    IabHelper.QueryInventoryFinishedListener mGotWidgetyListener = new IabHelper.QueryInventoryFinishedListener() {
        public void onQueryInventoryFinished(IabResult result, Inventory inventory) {
            ...
            Purchase premiumPurchase = inventory.getPurchase(WIDGET_TEXT_ITEM);
    ...
    public void onBuyWidgetButtonClicked(View arg0) {
        ...
        setWaitScreen(true);
        String payload = "sfnrfknfwewef_dnjke32df4f_fmerfnuifh734if4kfh89f8723tr62v3dd_dn34dbgkandndh347hf_d83hd34f7gfksdf_22"; 
        
        mHelper.launchPurchaseFlow(this, WIDGET_TEXT_ITEM, RC_REQUEST, mPurchaseFinishedListener, payload);
    }
    ...
    IabHelper.OnIabPurchaseFinishedListener mPurchaseFinishedListener = new IabHelper.OnIabPurchaseFinishedListener() {
        public void onIabPurchaseFinished(IabResult result, Purchase purchase) {
            ...
            if (purchase.getSku().equals(WIDGET_TEXT_ITEM)) {
