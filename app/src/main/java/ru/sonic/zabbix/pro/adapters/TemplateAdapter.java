...
class TemplateAdapterView extends LinearLayout {        
    public static final String LOG_TAG = "DefaultAdapterView";
    @SuppressWarnings("deprecation")
	public TemplateAdapterView(Context context,Object object ) {
        super(context);
...
public class TemplateAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) { 
        ...
        return new TemplateAdapterView(this.context, object );
    }
